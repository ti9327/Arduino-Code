...
#define SERIAL_TX_MP_PIN    17 // Y // Serial Rx pin for the Future Use serial port
#define SERIAL_RX_MP_PIN    18 // Y // Serial Rx pin for the Future Use serial port
#define MAINT_DATA_PIN      19 // Y // Unused Pin
#define NONEXISTENT_PIN_20  20 // N // There is no GPIO20
#define I2C_SDA             21 // Y // I2C SDA
#define I2C_SCL             22 // Y // I2C SCL
#define MAINT_CLOCK_PIN     23 // Y //  Radar Eye LED Data Pin 
