...
const ServoSettings servoSettings[] PROGMEM = {
    ...
    { 9,    740, 1700, PIE_PANEL_THREE },       /* 8: door 9 Pie Panel clockwise-2 from Periscope */
  ...
  if (servoBoard == 1 || servoBoard == 3 || servoBoard == 4){
    switch (doorpos){
      ...
      case 6: Debug.SERVO("Open Data Panel Door\n");
              ...
              sendESPNOWCommand("BS", stringToSend);                                        
              break;
      case 10: Debug.SERVO("Open Large Rear Left Door\n");
              snprintf(stringToSend, sizeof(stringToSend), ":D10110E%02d%04d%04d", servoEasingMethod, varSpeedMin, varSpeedMax);
              sendESPNOWCommand("BS", stringToSend);                                        
              break;
      case 11: Debug.SERVO("Open Large Rear Right Door\n");
              snprintf(stringToSend, sizeof(stringToSend), ":D10111E%02d%04d%04d", servoEasingMethod, varSpeedMin, varSpeedMax);
              sendESPNOWCommand("BS", stringToSend);                                        
              break;
    }
  };
  ...
  if (servoBoard == 1 || servoBoard == 3 || servoBoard == 4){
    switch(doorpos){
      ...
      case 6: Debug.SERVO("Close Data Panel Door\n");
              ...
              sendESPNOWCommand("BS", stringToSend);                                        
              break;
      case 10: Debug.SERVO("Close Large Rear eft Door\n");
              snprintf(stringToSend, sizeof(stringToSend), ":D10210E%02d%04d%04d", servoEasingMethod, varSpeedMin, varSpeedMax);
              sendESPNOWCommand("BS", stringToSend);                                        
              break;
      case 11: Debug.SERVO("Close Large Rear Right Door\n");
              snprintf(stringToSend, sizeof(stringToSend), ":D10211E%02d%04d%04d", servoEasingMethod, varSpeedMin, varSpeedMax);
              sendESPNOWCommand("BS", stringToSend);                                        
              break;
    }
  };
